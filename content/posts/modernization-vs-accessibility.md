...
Microsoft 認為雙指捲動更直觀、更自然，而且跨設備一致：手機用雙指縮放，平板用雙指捲動，筆電也該如此。精確式觸控板標準就是圍繞多點手勢設計的。
...
跨設備一致性優先於個人需求。所有人都該用同樣的方式操作，不符合「現代化」形象的功能就淘汰。
...
不是每個人都能做多點手勢。生理限制、使用習慣、設備限制，這些在產品經理的 OKR 裡可能只是「邊緣案例」，但對當事人來說是實實在在的障礙。
