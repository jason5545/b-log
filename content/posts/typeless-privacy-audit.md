...
語音輸入是我的主要輸入方式，不是選配。我從今年 1 月開始用 Typeless，付費訂閱了 Pro 年費方案（144 美元）。中英混合的辨識準確率確實接近完美，一度是我的首選工具。

然後日本工程師 @medmuspg 對 v0.9.3 做了逆向分析，發現嚴重的隱私問題，台灣科技媒體跟進報導。

我決定對自己 Mac 上的 **v1.0.0（build 79）** 做一次獨立的完整審計。
