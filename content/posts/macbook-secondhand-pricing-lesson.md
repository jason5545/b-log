...
第二間，不同店名、不同門市、不同的店員——開了 **45,000**。

一模一樣的數字。我站在那邊確認了兩次，確定自己沒聽錯。

第三間開了 **58,800**，是這一圈裡最接近行情的報價。

第四間開了 **25,000**。

我站在那個店員面前，腦子裡閃過的第一個念頭不是憤怒，是某種荒謬感——這台機器 1 月 17 日才啟用，今天才過了不到四個月，他的報價是 25,000？

---

## 同一個黑盒子

那兩間都開 45,000 的店，在我回家之後才想通。

台灣的連鎖二手 3C 通路，背後很可能共用同一套收購定價系統。你把型號、規格、外觀狀況輸入進去，系統吐出一個數字。不同店員、不同門市、不同品牌，輸出的是同一個結果——因為他們跑的是同一個演算法。
