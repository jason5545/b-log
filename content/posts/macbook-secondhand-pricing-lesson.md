...
第二間驗了半天，開了 **25,000**。我當場要求重新確認規格，他才改報 **45,000**。

不是沒看，是看完之後仍然把 CTO 配置報成 base model 的價——被挑戰了才改口。
...
第一件：那個 25,000 不是疏忽，是驗了半天之後給的數字。他不是沒看，是看完仍然把 CTO 報成 base model 的價，直到被要求重新確認才改口。這種開價方式更接近一種策略——先給一個低數字，看你的反應，被挑戰了再往上調。
