# macOS 沒有「加入側邊欄」的右鍵選項，我差點毀掉整個公司專案
...
Windows 在這件事上反而做得好。檔案總管裡對著資料夾按右鍵，「釘選到快速存取」就在選單裡，一個點擊搞定。不用拖曳、不用記快捷鍵、不用寫腳本。

Apple 號稱比 Windows 更注重使用者體驗，結果連 Windows 都做到的基本功能，macOS 要使用者自己寫 AppleScript 來補。
