...
兩邊的規格都照我的 house style 寫，驗收條件用「不准」「剛好」寫成絕對條件。這種寫法錯了一定現形，我不打算改。代價是每一條都得對著資料驗過才能發，而這一步之前沒人做。Opus 5 是在我的格式裡寫，它繼承的是我的習慣。
...
比對距離放寬那條也不能只看比例降了。要 Flash 印出 6 m 跟 12 m 各自對到的邊數，還有多邊形道路名稱跟 OSM name 不一致的邊數。12 m 的不一致率比 6 m 高超過 2 個百分點，就停下來回報，不准 commit。
