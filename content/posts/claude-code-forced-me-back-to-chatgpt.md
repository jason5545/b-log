...
相比之下，我在同一天請 Claude Code 幫我清理另一台電腦上《模擬飛行 2020》的 Windows 登錄檔。這跟軟體工程八竿子打不著——純粹是系統管理。而且那台電腦是完全乾淨的環境，沒有 CLAUDE.md，沒有任何自訂提示詞。Claude Code 照做了，沒有任何猶豫。
...
那為什麼 Theo 被硬拒、我沒有？原本我猜是 CLAUDE.md 的差異，但那台清登錄檔的電腦什麼自訂設定都沒有，這個解釋就站不住了。剩下的可能性是 API 層級有我們都看不到的額外注入、帳號之間的路由差異，或是時間點不同剛好踩到不同的模型行為。
