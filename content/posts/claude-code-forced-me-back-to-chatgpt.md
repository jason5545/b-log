...
我甚至把[當初寫給 GPT 的角色調整 prompt](https://b-log.to/posts/seven-ai-one-article) 翻了出來。那個 prompt 是幾個月前我和 Claude 一起設計的，當時的結論是「角色框架式的效果上限大概 70-80%，改不了深層問題」。現在拿回來用，不是因為它夠好，是因為沒有其他選擇。
