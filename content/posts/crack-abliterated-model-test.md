...
4. **有判斷力的對齊 > 無腦的去對齊**。在有正當理由的場景下，能理解脈絡的模型反而更好用。
5. **行銷用語要打折**。「no guardrails」「permanent safety removal」聽起來很徹底，實際上只做了一半，某些類型甚至完全沒做。
6. **開放原始碼的價值**。模型都躺在那邊了，abliteration 做不到的事情，LoRA fine-tune 可以接手。等新機器到了，值得自己動手試試。
