...
封面也是 Opus 5 在這個對話裡手寫的。這次我要它不用畫到上一張那麼細，控制在 15 KB 以內，讓整個流程快一點。畫出來是 9.3 KB、121 個元素：一支手機，螢幕上有一張向量圖正在被畫出來，旁邊一條路從手機接到伺服器，再接到部落格。深藍底，橘色是主角，這篇的 accentColor 也跟著用同一個橘色。
