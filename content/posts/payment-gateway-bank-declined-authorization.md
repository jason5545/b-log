...
### 立即動作
1. **停止嘗試付款** - 再試只會增加更多授權
2. **截圖保留證據** - 信用卡交易紀錄、網頁錯誤訊息
3. **檢查訂單記錄** - 確認商家那邊有沒有訂單
...
寫這篇文章的當下，是週六晚上。那三筆授權還靜靜地躺在信用卡紀錄裡。

作為工程師，我理解這種問題的技術成因，知道理論上應該會順利解決。但作為消費者，看著 6.7 萬的授權紀錄，心裡還是會七上八下。

**理性和感性是兩回事。**

知道「應該」沒問題，和「確定」沒問題，中間隔著的是整個週末的焦慮。

如果你也遇到類似狀況，希望這篇文章能幫你理解發生了什麼，知道該怎麼處理。但我也不會假裝說「完全不用擔心」——該緊張還是會緊張的。

只能說，保留證據、聯絡客服、等待處理。然後試著不要一直想這件事（雖然很難）。

**更新：週一商城部門處理完，會再補充後續結果。**

希望結果是好的。現在，我需要找點別的事情做，讓自己不要一直盯著那三筆授權看。
