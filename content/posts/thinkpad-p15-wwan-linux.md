...
如果是 E 系列（入門款）不支援，我還能理解——預算導向，砍功能省成本，買的人心裡有數。

但 P15 是旗艦工作站。售價六七萬起跳，目標客群是專業用戶：工程師、開發者、資料科學家。這群人跑 Linux 的比例遠高於一般消費者。

而且 P15 是主力機型，銷量不小。「沒有測試機所以沒辦法驗證」這種藉口根本站不住腳。

真正的原因大概是：

- WWAN unlock 工具的團隊和 P 系列產品線沒有對接好
- Linux 支援本來就是二等公民，沒人催就不做
- 加一個型號要走內部流程，沒人願意發起
- 反正大多數人用 Windows，Lenovo Vantage 能解鎖就好

不管是哪個，都不是「合規要求」。是組織問題，外部用戶買單。
