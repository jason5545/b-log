...
新帳號有 30 天 Pro 試用，不用綁卡。試用結束自動降回免費版。

4,000 字/週，平均一天約 570 字。日常短訊息夠用，但如果你像我一樣大量跟 AI 對話，會撞到限制。

---

## 平台

目前只有 iOS、macOS、Windows。

Android 和 Web 寫「Coming soon」。

我 12 月中剛換 iPhone，本來是因為 LINE 的 iCloud 備份比 Android 穩定。結果不到三週就發現 Typeless。如果我還在用 Android，這工具現在根本用不了。
...
技術路線是「準確度優先、隱私妥協」——用雲端 AI 換極高的辨識率和智能潤飾，代價是音訊會離開設備。
