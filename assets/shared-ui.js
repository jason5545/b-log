...
// 主題按鈕：ECAM 風格的狀態燈加上 AUTO／LIGHT／DARK 標籤
const THEME_DOT = '<i class="theme-dot" aria-hidden="true"></i>';
const THEME_TOGGLE_CONFIGS = {
  light: { svg: THEME_DOT, text: 'LIGHT' },
  dark: { svg: THEME_DOT, text: 'DARK' },
  auto: { svg: THEME_DOT, text: 'AUTO' }
};
